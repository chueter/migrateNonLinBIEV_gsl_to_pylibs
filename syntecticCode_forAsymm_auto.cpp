...
double lambda(1e5),gammaD(1e5),pG1(1e5),pG2(1e5),deltaG1(1e5),deltaG2(1e5),slopeG1(1e5),slopeG2(1e5),slopeG12(1e5),initialDisc(1e5),A_N_L_end(1e5),B_N_L_end(1e5),A_N_R_end(1e5),B_N_R_end(1e5),C_N_L_end(1e5),C_N_R_end(1e5),tailFactor(1e5),angle_two_phi(100.),angle_delta(100.),expG2(1e5),expG1(1e5), y_gridExp(1e5);
int BC_switch(10000);
...
void loopCalculations(const int indexCalculation);
const int numberOfCalculations(25);
int numberOfFinishedRuns(0);
string loadSwitch("test");
...
///////////////////////////////////////////////////////////////////////////////////////////////
	...
	for (int indexCalculation = 0; indexCalculation <= numberOfCalculations; indexCalculation++)
	{
		numberOfFinishedRuns = indexCalculation;
		loopCalculations(indexCalculation);
	}
	return 0;
}	
////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////
		...
		for (int yGridIndex=1; yGridIndex < numberGridPoints_y+addGridPoints; ++yGridIndex)
		{
			...
			yGrid.push_back(0.01+1.0*pow(yValue,y_gridExp));
		}
...
void setNumericalParameters(double& initialDiscretization, double& error_tol, string& gridSwitch, double& p1_o_p2)
{
	...
	initialDiscretization = 0.2635+0.0025*numberOfFinishedRuns;
	expG1 = 1.50;//+0.0001*numberOfFinishedRuns;
	expG2 = expG1;
	y_gridExp = 1.;
	gridSwitch = "tanh";
	error_tol = 5.*1e-2;
	initialDisc = initialDiscretization; // initialDisc is used as globally declared parameter for normalShift and naming 
	pG1 = 0.003260-0.00001*numberOfFinishedRuns;
	pG2 = 0.004039+0.00001*numberOfFinishedRuns;
...
void initializeSolutionVector(gsl_vector* x, double& p1_o_p2)
{
	double initialGuess[numberGridPoints+1+numberGridPoints_y], sigmaInitialGuess(1.11075494264353),deltaInitialGuess(angle_delta),lambdaInitialGuess(lambda);
